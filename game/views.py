...
def _build_game_buildings(services, projects, team, site_name):
    ...
    team_list = list(team)
    district_slots = {
        'software': [(65, -48), (100, -48), (80, -24), (115, -24), (65, 0), (80, 0), (100, 0), (80, 24), (115, 24)],
        'marketing': [(-28, 40), (-12, 40), (12, 40), (28, 40), (-95, 70), (-65, 70), (-50, 70)],
        'consulting': [(-100, -86), (-75, -86), (-50, -86), (25, -86)],
    }
    slot_idx = {'software': 0, 'marketing': 0, 'consulting': 0, 'innovation': 0}
    innovation_slots = [(-28, -48), (-32, -24), (-32, 0), (-24, 24), (-24, 46)]
...
def world(request):
    ...
    game_data = {
        ...
        'districts': [
            {'id': 'software', 'label': 'Tech Hub', 'x': 80, 'z': 0, 'color': '#4c8fe3'},
            {'id': 'marketing', 'label': 'Market & Bazaar', 'x': 0, 'z': 55, 'color': '#f08b3a'},
            {'id': 'innovation', 'label': 'Residential Hub', 'x': -25, 'z': 20, 'color': '#8a78d8'},
            {'id': 'hq', 'label': 'Showrooms', 'x': 0, 'z': -75, 'color': '#4ed2c8'},
            {'id': 'park', 'label': 'Atrium Park', 'x': 0, 'z': 0, 'color': '#e8a6b7'},
        ],
        'buildings': buildings,
